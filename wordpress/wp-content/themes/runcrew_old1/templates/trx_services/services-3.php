...
if ( !function_exists( 'runcrew_template_services_3_theme_setup' ) ) {
	add_action( 'runcrew_action_before_init_theme', 'runcrew_template_services_3_theme_setup', 1 );
	function runcrew_template_services_3_theme_setup() {
		runcrew_add_template(array(
			'layout' => 'services-3',
			'template' => 'services-3',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 3/', 'runcrew'),
...
// Template output
if ( !function_exists( 'runcrew_template_services_3_output' ) ) {
	function runcrew_template_services_3_output($post_options, $post_data) {
