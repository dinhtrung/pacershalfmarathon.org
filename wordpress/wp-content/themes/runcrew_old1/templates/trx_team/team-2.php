...
if ( !function_exists( 'runcrew_template_team_2_theme_setup' ) ) {
	add_action( 'runcrew_action_before_init_theme', 'runcrew_template_team_2_theme_setup', 1 );
	function runcrew_template_team_2_theme_setup() {
		runcrew_add_template(array(
			'layout' => 'team-2',
			'template' => 'team-2',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_pagination sc_slider_pagination_bottom sc_slider_nocontrols',*/
			'title'  => esc_html__('Team /Style 2/', 'runcrew'),
...
// Template output
if ( !function_exists( 'runcrew_template_team_2_output' ) ) {
	function runcrew_template_team_2_output($post_options, $post_data) {
		$show_title = true;
