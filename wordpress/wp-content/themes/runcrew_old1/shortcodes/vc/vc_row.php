...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by RunCrew
	 * @var $inverse	- added by RunCrew
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by RunCrew:
	// Color scheme
	if ($scheme && !runcrew_param_is_off($scheme) && !runcrew_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !runcrew_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add RunCrew color scheme in the row
	if ($scheme && !runcrew_param_is_off($scheme) && !runcrew_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
