...
if ( !function_exists( 'runcrew_template_news_portfolio_theme_setup' ) ) {
	add_action( 'runcrew_action_before_init_theme', 'runcrew_template_news_portfolio_theme_setup', 1 );
	function runcrew_template_news_portfolio_theme_setup() {
		runcrew_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'runcrew'),
...
// Template output
if ( !function_exists( 'runcrew_template_news_portfolio_output' ) ) {
	function runcrew_template_news_portfolio_output($post_options, $post_data) {
