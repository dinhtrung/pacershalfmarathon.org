...
if ( !function_exists( 'runcrew_template_related_theme_setup' ) ) {
	add_action( 'runcrew_action_before_init_theme', 'runcrew_template_related_theme_setup', 1 );
	function runcrew_template_related_theme_setup() {
		runcrew_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'runcrew'),
		...
		runcrew_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'runcrew'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'runcrew'),
			'w'		 => 370,
			'h'		 => 370
		));
		runcrew_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'runcrew'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'runcrew'),
			'w'		 => 370,
			'h'		 => 370
		));
		runcrew_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'runcrew'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'runcrew'),
			'w'		 => 370,
			'h'		 => 370
		));
...
// Template output
if ( !function_exists( 'runcrew_template_related_output' ) ) {
	function runcrew_template_related_output($post_options, $post_data) {
