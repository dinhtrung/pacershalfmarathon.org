...
if ( !function_exists( 'runcrew_template_players_1_theme_setup' ) ) {
	add_action( 'runcrew_action_before_init_theme', 'runcrew_template_players_1_theme_setup', 1 );
	function runcrew_template_players_1_theme_setup() { 
		runcrew_add_template(array(
			'layout' => 'players-1',
			'template' => 'players-1',
			'mode'   => 'players',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_bottom',*/
			'title'  => esc_html__('Players /Style 1/', 'runcrew'),
...
// Template output
if ( !function_exists( 'runcrew_template_players_1_output' ) ) {
	function runcrew_template_players_1_output($post_options, $post_data) { 
		$show_title = true;
