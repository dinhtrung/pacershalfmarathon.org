...
if ( !function_exists( 'runcrew_template_testimonials_3_theme_setup' ) ) {
	add_action( 'runcrew_action_before_init_theme', 'runcrew_template_testimonials_3_theme_setup', 1 );
	function runcrew_template_testimonials_3_theme_setup() {
		runcrew_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 3/', 'runcrew'),
...
// Template output
if ( !function_exists( 'runcrew_template_testimonials_3_output' ) ) {
	function runcrew_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
