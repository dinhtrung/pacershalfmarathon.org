...
function wpb_adding_scripts() {
	wp_register_script('sha', get_template_directory_uri() . '/js/aes.js', array('jquery'),'1.1', true);
	wp_register_script('aes', get_template_directory_uri() . '/js/sha256.js', array('jquery'),'1.1', true);
	wp_enqueue_script('sha');
	wp_enqueue_script('aes');
}
